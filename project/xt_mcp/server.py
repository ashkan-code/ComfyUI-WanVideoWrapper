...
# Phase 13 — multi-timeframe analysis
mcp.tool()(analyze_multi_timeframe)

# Phase 14 — symbol summary report
mcp.tool()(get_symbol_report)

# Phase 15 — candlestick pattern detection
